...
### {ggstamp} [*on github*](github.com/EvaMaeRey/ggstamp){target="_blank"}
...
In practice, the data is declared first and second the aesthetic-variable encodings. Finally, with this *groundwork laid* of prespecifying data and aesthetic-variable pairs, the code call to get the geometric layer feels light and nimble!  
